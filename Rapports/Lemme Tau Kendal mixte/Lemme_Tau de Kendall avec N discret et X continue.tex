	...
	\begin{exemple}\label{exemple_code1}
		...
		\begin{table}[H]
			...
			\begin{tabular}{rrrrrrrrrrrrrrrrrrrrr}
				...
				\hline
			\end{tabular}
		\caption{Réalisations du couple $(X,Y)$, où $X \sim Y \sim Poisson(10)$. }
		\end{table}
