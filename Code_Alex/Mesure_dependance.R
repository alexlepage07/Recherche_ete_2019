...
#---------------------------------- Inversion du tau de Kendall -------------------
    ...
    depend_optim <- function(F_N, F_X,
                             ...
                             Tau_Kendall,
                             n_max=1e+2, x_max=1e+4){
        # Fonction qui permet de trouver le paramètre de dépendance à l'aide du tau de Kendall 
        # empirique.
        #
        #=========== Bornes: ========
        # Frank: (-infty, infty) / {0}
...
# Calcul du alpha à l'aide du tau de Kendal théorique
tau_theorique <- tau_kendall_theorique(F_N, F_X,
                                       para,
                                       Copule,
                                       alpha,
